...
app_id='${app_id}'
model_dir="/mnt/mffuse/pretrain_recommendation/Proposed/fineweb_contrastive_checkpoint/conda-torchrun-li1-nz73p79/pythia_410m_fineweb_contrastive_1e-5_1024_64_0.01/name/checkpoint-5000/"
data_dir="/mnt/mffuse/scaling_law/taste_data/${model}/${data_set}"
output_dir="/mnt/mffuse//pretrain_recommendation/Proposed/contrastive_pretrain_finetune/${data_set}_checkpoint/${app_id}/"
