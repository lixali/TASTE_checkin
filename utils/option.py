"""
Options (this comment is just for formatting issue)
"""
...
class Options:
    ...
    def initialize_parser(self):
        ...
        self.parser.add_argument(
            ...
            type=str,
            default="ndcg",
            help="metrics to optimize for saving the best checkpoint: recall / ndcg",
        )
        self.parser.add_argument(
            "--metrics_val",
            type=int,
            default=10,
            help="value to optimize for saving the best checkpoint: metrics@k, k in [10, 20]",
        )
